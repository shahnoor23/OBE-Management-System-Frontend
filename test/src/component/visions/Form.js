      ...
      <div>
        ...
        <form onSubmit={this.onSubmit}>
          ...
          <div className="form-group">
            ...
            <button type="submit" className="btn btn-success" onClick={()=>{this.props.history.push('/mission')}}>
              Next
            </button>
          </div>
        </form>
...
export default connect(mapStateToProps, { addVision, getPeos })(withRouter(Form));
