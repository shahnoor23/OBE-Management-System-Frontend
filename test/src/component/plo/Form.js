      ...
      <div>
        ...
        <form onSubmit={this.onSubmit}>
          ...
          <div className="form-group">
            ...
            <button type="submit" className="btn btn-success" onClick={()=>{this.props.history.push('/cognitive')}}>
              Next
            </button>
          </div>
        </form>
...
export default connect(mapStateToProps, { addPlo, getPeos })(withRouter(Form));
